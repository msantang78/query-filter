...
class MakeQueryFilterCommandTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->command = m::mock('Msantang\QueryFilters\Commands\MakeQueryFilter[argument]', [$this->filesystem]);
    }
    ...
    public function testMakeClassName($argument, $class)
    {
        ...
        $this->assertEquals("App\\QueryFilters\\$class", $this->command->getClassName());
    }
